...
const failures = [];
if (fixture.includes(PRODUCTION_REF) || cleanup.includes(PRODUCTION_REF)) {
  failures.push('staging fixture SQL contains the production project ref');
}
...
console.log('PASS staging database fixture and cleanup files are paired, non-login, and exact-ref documented');
